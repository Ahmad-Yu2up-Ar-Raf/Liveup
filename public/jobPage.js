  ...
  Alpine.data("lowongan", () => ({
    jobs: [
      ...
      },
      {
        ...
        companyDescription:
          "Amazon adalah salah satu perusahaan terbesar di dunia yang menyediakan berbagai layanan mulai dari e-commerce hingga komputasi awan. Kami berkomitmen untuk inovasi dan mempermudah kehidupan pelanggan kami.",
        location: "UK",
      },
      {
        id: 3,
        ...
        companyDescription:
          "Microsoft adalah pemimpin dunia dalam perangkat lunak dan layanan teknologi, termasuk sistem operasi Windows, Office, dan Azure. Kami menciptakan inovasi untuk membantu semua orang di dunia mencapai lebih banyak.",
        location: "USA",
      },
      {
        id: 4,
        ...
        skills: ["Agile", "Product Management", "Strategic Thinking"],
        companyDescription:
          "Meta adalah perusahaan induk Facebook yang berfokus pada pengembangan teknologi sosial dan aplikasi seperti Instagram, WhatsApp, dan Oculus. Kami berkomitmen untuk menciptakan konektivitas di seluruh dunia.",
        location: "USA",
      },
      {
        id: 5,
        ...
        skills: ["Swift", "Xcode", "UI/UX Design"],
        companyDescription:
          "Apple adalah perusahaan teknologi global yang terkenal dengan inovasi produk-produk seperti iPhone, iPad, dan Mac. Kami berfokus pada menciptakan pengalaman pengguna yang luar biasa.",
        location: "USA",
      },
      {
        id: 6,
        ...
        companyDescription:
          "Facebook adalah platform jejaring sosial terbesar di dunia. Kami menghubungkan orang, komunitas, dan bisnis di seluruh dunia untuk menciptakan dampak positif.",
        location: "USA",
      },
      {
        id: 7,
        ...
        skills: ["Strategi Konten", "SEO", "Analisis Data"],
        companyDescription:
          "YouTube adalah platform berbagi video terkemuka yang memungkinkan pengguna untuk menonton, mengunggah, dan berbagi video di seluruh dunia.",
        location: "USA",
      },

      {
        ...
        skills: ["Pembelajaran Mesin", "Penelitian AI", "Pemrograman Python"],
        companyDescription:
          "OpenAI adalah organisasi penelitian kecerdasan buatan yang berfokus pada pengembangan dan penerapan AI untuk manfaat umat manusia.",
        location: "USA",
      },

      {
        ...
        skills: ["Manajemen Produksi", "Kreativitas", "Pengawasan Produksi"],
        companyDescription:
          "Netflix adalah platform streaming video terkemuka yang menawarkan film, acara TV, dan konten orisinal berkualitas tinggi kepada pengguna di seluruh dunia.",
        location: "USA",
      },
    ],
  }));
